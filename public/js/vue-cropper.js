!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? define("vue-cropper", [], e)
    : "object" == typeof exports
    ? (exports["vue-cropper"] = e())
    : (t["vue-cropper"] = e());
})(window, function () {
  return (function (t) {
    var e = {};
    ...
    function (t, e, o) {
      ...
      function u(t, e) {
        for (var o = [], n = {}, r = 0; r < t.length; r++) {
          ...
          n[s] ? n[s].parts.push(a) : o.push((n[s] = { id: s, parts: [a] }));
        }
        return o;
      }
      function d(t, e) {
    ...
    function (t, e, o) {
        ...
        return o(
          ...
          [
            ...
            o(
              ...
              [
                o("span", { staticClass: "cropper-view-box" }, [
                  o("img", {
                    style: {
                      width: t.trueWidth + "px",
                      height: t.trueHeight + "px",
                ...
                t.info
                  ? o(
                      ...
                      [
                        t._v(
                          t._s(this.cropInfo.width) +
                            " × " +
                            t._s(this.cropInfo.height)
                        ),
                      ]
                    )
                  : t._e(),
                ...
                (n.orientation = (function (t) {
                  ...
                  s &&
                    ...
                    "Exif" ===
                      ...
                      ((i = p.getUint16(o)),
                      ((r = 18761 === i) || 19789 === i) &&
                        42 === p.getUint16(o + 2, r) &&
                        (n = p.getUint32(o + 4, r)) >= 8 &&
                        (a = o + n)));
                  if (a)
                    for (u = p.getUint16(a, r), h = 0; h < u; h++)
            ...
            cropInfo: function () {
              ...
              if (
                ...
                this.high && !this.full && (e = window.devicePixelRatio),
                  (1 !== this.enlarge) & !this.full &&
                    (e = Math.abs(Number(this.enlarge))),
                  (t.width = t.width * e),
                  (t.height = t.height * e),
                  this.full &&
                    ((t.width = t.width / this.scale),
                    (t.height = t.height / this.scale));
              }
              return (
                (t.width = t.width.toFixed(0)),
          ...
          methods: {
            ...
            startMove: function (t) {
              if ((t.preventDefault(), this.move && !this.crop)) {
                ...
                (this.moveX =
                  (t.clientX ? t.clientX : t.touches[0].clientX) - this.x),
                  (this.moveY =
                    (t.clientY ? t.clientY : t.touches[0].clientY) - this.y),
                  t.touches
            ...
            touchScale: function (t) {
              ...
              var o = this.scale,
                ...
                f =
                  (l =
                    (l =
                      l / this.trueWidth > l / this.trueHeight
                        ? l / this.trueHeight
                        : l / this.trueWidth) > 0.1
                      ? 0.1
                      : l) * d;
              if (!this.touchNow) {
                if (
            ...
            moveImg: function (t) {
              ...
              (o = r - this.moveX),
                ...
                this.$nextTick(function () {
                  if (e.centerBox) {
                    ...
                    switch (e.rotate) {
                      ...
                      case -3:
                        (t =
                          e.cropOffsertX -
                          (e.trueWidth * (1 - e.scale)) / 2 +
                          (h - p) / 2),
                          (r =
                            e.cropOffsertY -
                            (e.trueHeight * (1 - e.scale)) / 2 +
                            (p - h) / 2),
                          (i = t - h + e.cropW),
                          (s = r - p + e.cropH);
                        break;
                      default:
                        (t =
                          e.cropOffsertX - (e.trueWidth * (1 - e.scale)) / 2),
                          (r =
                            e.cropOffsertY -
                            (e.trueHeight * (1 - e.scale)) / 2),
                          (i = t - p + e.cropW),
                  ...
                  (e.x = o),
                    (e.y = n),
                    e.$emit("imgMoving", { moving: !0, axis: e.getImgAxis() }),
                    e.$emit("img-moving", { moving: !0, axis: e.getImgAxis() });
                });
            },
            leaveImg: function (t) {
            ...
            changeSize: function (t) {
              ...
              i < 0
                ? (o += Math.abs(i))
                : o > Math.abs(i) && (o -= Math.abs(i));
              var s = i < 0 ? "add" : "reduce";
              if (
                (s !== this.coeStatus &&
                  ((this.coeStatus = s), (this.coe = 0.2)),
                this.scaling ||
            ...
            createCrop: function (t) {
              ...
              this.$nextTick(function () {
                ...
                if (
                  (t > 0
                    ? ((e.cropW =
                        t + e.cropChangeX > e.w ? e.w - e.cropChangeX : t),
                      (e.cropOffsertX = e.cropChangeX))
                    : ((e.cropW =
                        e.w - e.cropChangeX + Math.abs(t) > e.w
                          ? e.cropChangeX
                          : Math.abs(t)),
                      (e.cropOffsertX =
                        e.cropChangeX + t > 0 ? e.cropChangeX + t : 0)),
                  e.fixed)
                ) {
                  var i = (e.cropW / e.fixedNumber[0]) * e.fixedNumber[1];
                  i + e.cropOffsertY > e.h
                    ? ((e.cropH = e.h - e.cropOffsertY),
                      (e.cropW =
                        (e.cropH / e.fixedNumber[1]) * e.fixedNumber[0]),
                      (e.cropOffsertX =
                        t > 0 ? e.cropChangeX : e.cropChangeX - e.cropW))
                    : (e.cropH = i),
            ...
            changeCropNow: function (t) {
              ...
              this.$nextTick(function () {
                ...
                if (
                  (e.canChangeX &&
                    (1 === e.changeCropTypeX
                      ? e.cropOldW - t > 0
                        ? ((e.cropW =
                            r - e.cropChangeX - t <= r - s
                              ? e.cropOldW - t
                              : e.cropOldW + e.cropChangeX - s),
                          (e.cropOffsertX =
                            r - e.cropChangeX - t <= r - s
                              ? e.cropChangeX + t
                              : s))
                        : ((e.cropW =
                            Math.abs(t) + e.cropChangeX <= r
                              ? Math.abs(t) - e.cropOldW
                              : r - e.cropOldW - e.cropChangeX),
                          (e.cropOffsertX = e.cropChangeX + e.cropOldW))
                      : 2 === e.changeCropTypeX &&
                        (e.cropOldW + t > 0
                          ? ((e.cropW =
                              e.cropOldW + t + e.cropOffsertX <= r
                                ? e.cropOldW + t
                                : r - e.cropOffsertX),
                            (e.cropOffsertX = e.cropChangeX))
                          : ((e.cropW =
                              r - e.cropChangeX + Math.abs(t + e.cropOldW) <=
                              r - s
                                ? Math.abs(t + e.cropOldW)
                                : e.cropChangeX - s),
                            (e.cropOffsertX =
                              r - e.cropChangeX + Math.abs(t + e.cropOldW) <=
                              r - s
                                ? e.cropChangeX - Math.abs(t + e.cropOldW)
                                : s)))),
                  e.canChangeY &&
                    (1 === e.changeCropTypeY
                      ? e.cropOldH - c > 0
                        ? ((e.cropH =
                            i - e.cropChangeY - c <= i - a
                              ? e.cropOldH - c
                              : e.cropOldH + e.cropChangeY - a),
                          (e.cropOffsertY =
                            i - e.cropChangeY - c <= i - a
                              ? e.cropChangeY + c
                              : a))
                        : ((e.cropH =
                            Math.abs(c) + e.cropChangeY <= i
                              ? Math.abs(c) - e.cropOldH
                              : i - e.cropOldH - e.cropChangeY),
                          (e.cropOffsertY = e.cropChangeY + e.cropOldH))
                      : 2 === e.changeCropTypeY &&
                        (e.cropOldH + c > 0
                          ? ((e.cropH =
                              e.cropOldH + c + e.cropOffsertY <= i
                                ? e.cropOldH + c
                                : i - e.cropOffsertY),
                            (e.cropOffsertY = e.cropChangeY))
                          : ((e.cropH =
                              i - e.cropChangeY + Math.abs(c + e.cropOldH) <=
                              i - a
                                ? Math.abs(c + e.cropOldH)
                                : e.cropChangeY - a),
                            (e.cropOffsertY =
                ...
                if (e.canChangeY && e.fixed) {
                  ...
                  p + e.cropOffsertX > r
                    ? ((e.cropW = r - e.cropOffsertX),
                      (e.cropH =
                        (e.cropW / e.fixedNumber[0]) * e.fixedNumber[1]))
                    : (e.cropW = p);
                }
              });
            },
            ...
            cropMove: function (t) {
              ...
              if (t.touches && 2 === t.touches.length)
                return (
                  (this.crop = !1), this.startMove(t), this.leaveCrop(), !1
                );
              ...
              t &&
                ...
                this.$nextTick(function () {
                  var t,
                    ...
                    a = r - o.cropY;
                  if (
                    (e && ((s = o.cropOffsertX), (a = o.cropOffsertY)),
              ...
              (n.onload = function () {
                if (0 !== e.cropW) {
                  ...
                  e.high & !e.full && (u = window.devicePixelRatio),
                    (1 !== e.enlarge) & !e.full &&
                      ((u = Math.abs(Number(e.enlarge))), console.log(u));
                  var d = e.cropW * u,
                    l = e.cropH * u,
                    f = i * e.scale * u,
                    g = s * e.scale * u,
            ...
            showPreview: function () {
              ...
              var e = this.cropW,
                ...
                n = this.scale,
                r = {};
              r.div = { width: "".concat(e, "px"), height: "".concat(o, "px") };
            ...
            reload: function () {
              ...
              (e.onload = function () {
                (t.w = parseFloat(
                  window.getComputedStyle(t.$refs.cropper).width
                )),
                  (t.h = parseFloat(
                    window.getComputedStyle(t.$refs.cropper).height
                  )),
                  (t.trueWidth = e.width),
                  ...
                  t.$nextTick(function () {
                    (t.x =
                      -(t.trueWidth - t.trueWidth * t.scale) / 2 +
                      (t.w - t.trueWidth * t.scale) / 2),
                      (t.y =
                        -(t.trueHeight - t.trueHeight * t.scale) / 2 +
                        (t.h - t.trueHeight * t.scale) / 2),
                      (t.loading = !1),
              ...
              switch (o[0]) {
                case "contain":
                  this.trueWidth > this.w && (t = this.w / this.trueWidth),
                    this.trueHeight * t > this.h &&
                      (t = this.h / this.trueHeight);
                  break;
                case "cover":
                  (e *= t = this.w / this.trueWidth) < this.h &&
                    (t = (e = this.h) / this.trueHeight);
                  break;
                default:
                  try {
                    var n = o[0];
                    if (
                      ...
                      -1 !== n.search("%") &&
                        ((n = n.replace("%", "")),
                        (t =
                          ((parseFloat(n) / 100) * this.w) / this.trueWidth)),
                      2 === o.length && "auto" === n)
                    ) {
                      var r = o[1];
                      -1 !== r.search("px") &&
            ...
            goAutoCrop: function (t, e) {
              ...
              (0 !== s && 0 !== a) || ((s = 0.8 * o), (a = 0.8 * n)),
                (s = s > o ? o : s),
                (a = a > n ? n : a),
                this.fixed &&
                  (a = (s / this.fixedNumber[0]) * this.fixedNumber[1]),
                a > this.h &&
                  (s =
                    ((a = this.h) / this.fixedNumber[1]) * this.fixedNumber[0]),
                this.changeCrop(s, a);
            },
            changeCrop: function (t, e) {
              ...
              if (this.centerBox) {
                ...
                t > n.x2 - n.x1 &&
                  (e =
                    ((t = n.x2 - n.x1) / this.fixedNumber[0]) *
                    this.fixedNumber[1]),
                  e > n.y2 - n.y1 &&
                    (t =
                      ((e = n.y2 - n.y1) / this.fixedNumber[1]) *
                      this.fixedNumber[0]);
              }
              (this.cropW = t),
                (this.cropH = e),
                ...
                Object.defineProperty(HTMLCanvasElement.prototype, "toBlob", {
                  value: function (e, o, n) {
                    for (
                      ...
                      s[a] = r.charCodeAt(a);
                    e(new Blob([s], { type: t.type || "image/png" }));
                  },
                }),
              this.showPreview(),
              this.checkedImg();
      ...
      var a = (function (t, e, o, n, r, i, s, a) {
        ...
        if (
          (e && ((h.render = e), (h.staticRenderFns = o), (h._compiled = !0)),
          n && (h.functional = !0),
