    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        var __WEBPACK_AMD_DEFINE_ARRAY__,
          __WEBPACK_AMD_DEFINE_RESULT__; /* exif */
        (function () {
          var debug = false;
        ...
        (function () {
          ...
          MegaPixImage.prototype.render = function (target, options, callback) {
            ...
            var srcImage = this.srcImage,
              ...
              doSquash =
                (this.blob && this.blob.type === "image/jpeg") ||
          ...
          if (true) {
            ...
            __WEBPACK_AMD_DEFINE_RESULT__ !== undefined &&
              (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)); // for AMD loader
          } else {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var UA = (function (userAgent) {
          ...
          return {
            ...
            oldAndroid: isOldAndroid
              ? +isOldAndroid.pop().substr(0, 3) < 4.5
              : false,
        ...
        function Lrz(file, opts) {
          ...
          if (!file)
            throw new Error(
              "没有收到图片，可能的解决方案：https://github.com/think2011/localResizeIMG/issues/7"
            );
            ...
            img.onload = function () {
              that
                ...
                .then(function (base64) {
                  ...
                  if (
                    typeof that.file === "object" &&
                    base64.length > that.file.size
                  ) {
                  ...
                  formData.append(
                    that.defaults.fieldName,
                    file,
                    that.fileName.replace(/\..+/g, ".jpg")
                  );
          ...
          return new Promise(function (resolve) {
            try {
              ...
              exif.getData(typeof file === "object" ? file : img, function () {
                that.orientation = that.defaults.ingnoreOrientation
                  ? 0
